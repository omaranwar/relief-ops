        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-12 md:col-span-8 lg:col-span-9 space-y-6">
            ...
            <div className="grid grid-cols-12 gap-4 items-stretch">
              <div className="col-span-12 xl:col-span-6"><MapView /></div>
              <div className="col-span-12 xl:col-span-6"><ActionPlanCard incidentId={selectedIncidentId} /></div>
            </div>

            <IncidentsTable onRunPlan={(id) => { console.log("App received onRunPlan:", id); setSelectedIncidentId(id); }} />
